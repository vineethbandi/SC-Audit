                ...
                <div className="text-left">
                  ...
                  {expandedSection === "suggestions" && (
                    <>
                      ...
                      <button
                        onClick={fixIssues}
                        className="mt-4 rounded-full inline-flex items-center px-4 py-2 border border-transparent text-base leading-6 font-medium  text-white bg-black-600 hover:bg-black-500 focus:outline-none focus:border-black-700 focus:shadow-outline-black active:bg-black-700 transition ease-in-out duration-150"
                      >
